...
<head>
    ...
    <link rel="stylesheet" href="../styles/stFaleConosco/styleFaleConosco.css">
    <link
...
<body>
            ...
            <ul id="navicon" class="navbar-nav ">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="./pages/FaleConosco.html">Contatos</a></li>
    ...
    <section id="conteiner">
      <div id="boxFaleConosco" class="row">
        
        <div id="quemSomos" class="col-12">
          <h3 class="titulo">Quem Somos</h3>
          <p>Fundado em 2024, A Fifty Hards é um projeto de faculdade onde tem como objetivo realizar um ecommerce de vendas de Hardwares e acessórios de tecnologia.</p>
          ...
          <p>Em breve uma loja fisica!</p>
        </div>

        <div id="faleConosco" class="col-sm-6">
          <h3 class="titulo">Fale Conosco</h3>
          <p>0800 5588 5884 4848 <br> (71)986770382</p>
          <strong>E-mail</strong>
          <p>fifthyhards@gmail.com</p>
        </div>

        <div id="autor" class="col-sm-6">
          <h3 class="titulo">Autor do Site</h3>
          <strong>Maxwel Alves</strong>

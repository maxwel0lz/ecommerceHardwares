...
<html lang="pt-br">
  <head>
    ...
    <title>Fifty Hards</title>
    <link rel="shortcut icon" href="/assets/logo2-fiftyhards.svg" type="image/x-icon">
    <link rel="stylesheet" href="global.css" />
    <link rel="stylesheet" href="styles/stProdutos/styleProdutos.css" />
    <link
  ...
  <body>
          ...
          <ul id="navicon" class="navbar-nav ">
            ...
            <li class="nav-item">    
              <?php
                ...
                echo '<a class="nav-link active" aria-current="page" href="pages/login.php"><svg xmlns="http://www.w3.org/2000/svg"  width="25"height="25" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16"><path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/></svg>Login / Register</a>';
              }
              ?> 
    ...
    <section id="itensbar">
      <ul id="lista" class="nav">
        <li class="nav-item">
          <a class="nav-link " aria-current="page" href="#">Fonte</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Memorias</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Processador</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Placa Mãe</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Gabinetes</a>
        </li>
        <li class="nav-item">
          <a  class="nav-link" aria-disabled="true">Perifericos</a>
        </li>
      </ul>
    </section>
          <!-- CARROCEL  -->
    <div id="carouselRide" class="carousel slide" data-bs-ride="true">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="assets/DESCONTO EM TODA A COLEÇÃO VERÃO..png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="https://www.pichau.com.br/_next/image?url=https%3A%2F%2Fmedia.pichau.com.br%2Fmedia%2Faw_rbslider%2Fslides%2F2024_-_22_mar_a_01_abr_Logitech_1450x140.webp&w=1920&q=75"" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="assets/DESCONTO EM TODA A COLEÇÃO VERÃO..png" class="d-block w-100" alt="...">
        </div>
